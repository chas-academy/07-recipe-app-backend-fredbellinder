    ...
    public function run()
    {
        ...
        foreach ($datamapped as $obj) {
            Recipe::create(
                ...
                'dietLabels' => serialize($obj['recipe']['dietLabels']),
                'healthLabels' => serialize($obj['recipe']['healthLabels']),
                'ingredientLines' => serialize($obj['recipe']['ingredientLines']),
                'ingredients' => serialize($obj['recipe']['ingredients']),
